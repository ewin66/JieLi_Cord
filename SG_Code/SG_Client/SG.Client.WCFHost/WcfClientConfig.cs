///*************************************************************************/
///*
///* 文件名    ：WcfClientConfig.cs                                      
///* 程序说明  : 从config文件加载WCF服务配置。
///* 原创作者  ：东莞思谷 XW Peng 
///* 
...
namespace SG.Client.WCFHost
{
    ...
    public class WcfClientConfig
    {
        ...
        {
            get { return Application.StartupPath + @"\SG.Client.WCFHost.dll.config"; }
        }
        ...
        /// <returns></returns>
        public static string GetWcfRemoteAddress(string endPointName)
        {
            XmlDocument xml = new XmlDocument();
            xml.Load(WcfClientConfig.ConfigFile);
