...
namespace SG.Common
{
    ...
    {
        public const string DEF_PROGRAM_NAME = "东莞思谷快速开发框架-2.0";
        ...
        /// </summary>
        public const string DEF_SYSTEM_DB = "SG.System";
        ...
        {
            string file = Application.StartupPath + @"\image\" + imgFileName;
            if (File.Exists(file))
    ...
    /// 数据库类型
    /// </summary>
    public struct DbAcessTyp
    {
        public static string Oracle = "Oracle";
        public static string SQLServer = "SQLServer";
        public static string Access = "Access";
        public static string DB2 = "DB2";
        public static string Sysbase = "Sysbase";
    }
}
